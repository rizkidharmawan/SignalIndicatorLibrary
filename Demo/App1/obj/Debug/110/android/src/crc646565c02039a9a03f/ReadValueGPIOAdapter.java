...
public class ReadValueGPIOAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.ReadValueGPIOAdapter, SampleGpioPort", ReadValueGPIOAdapter.class, __md_methods);
	}


	public ReadValueGPIOAdapter ()
	{
		super ();
		if (getClass () == ReadValueGPIOAdapter.class)
			mono.android.TypeManager.Activate ("App1.ReadValueGPIOAdapter, SampleGpioPort", "", this, new java.lang.Object[] {  });
	}
