...
public class SignalBarActivity
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.SignalBarActivity, SampleGpioPort", SignalBarActivity.class, __md_methods);
	}


	public SignalBarActivity ()
	{
		super ();
		if (getClass () == SignalBarActivity.class)
			mono.android.TypeManager.Activate ("App1.SignalBarActivity, SampleGpioPort", "", this, new java.lang.Object[] {  });
	}
